...
void savefile()
{
	...
	printf("\n\n\t Your Details have been saved to a file (k_airline records)");
	fclose(fpointer);
}
...
void cancel_ticket()
{
	...
	system("cls");
	char passport[6];
	printf("\n\n Enter your six digit passort number to delete ticket booking:");
	...
	printf("The Passport Number you have entered doesn't match our records, please check again");
